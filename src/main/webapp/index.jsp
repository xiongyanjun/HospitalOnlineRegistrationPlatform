...
<body class="gray-bg">
	<div class="row  border-bottom white-bg dashboard-header">
		<div style="height: 50px" class="col-sm-12">
				<a href="${contextPath}/page/login.jsp" class="btn btn-lg btn-danger" style="width:100%;height: 50px;margin-bottom: 20px;margin-top: -20px;text-align: center">登陆或注册</a>
		</div>
		<div class="col-sm-12">
			<img src="${contextPath}/img/c6.jpg" width="200%"
				style="max-width: 100%;margin-top: -20px;"> <br>
		</div>
