...
<body class="gray-bg">
				...
				<div class="ibox float-e-margins">
					<div class="ibox-content mailbox-content">
						<div class="file-manager">
							<a class="btn btn-block btn-info compose-mail" href="${contextPath}/page/customer/customerMain.jsp">用户须知</a>
							<div class="space-25"></div>
							<ul class="folder-list m-b-md" style="padding: 0">
								<li><a href="${contextPath}/page/customer/UserInfo.jsp">
										<i class="fa fa-user "></i> 用户信息
								</a></li>
								<li><a href="${contextPath}/Customer/department">
    ...
    var contextPath="<%=contextPath%>";
    	...
    	function yuyueguahao(pageNo){
			$.ajax({
				url : contextPath + "/Customer/yuyueguahao?pageNo="+pageNo,
				type : "get",
				dataType : "text",
		...
		function yuyue(a,uid){
			...
			$.ajax({
				...
				type : "POST",
				data : {
					"jnumber" : jnumber,"ydate":ydate,"ytime":ytime,"uid":uid
				},
				dataType : "text",
				success : function(datas) {
					if(datas==1){
