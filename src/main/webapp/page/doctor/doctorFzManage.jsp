...
<body class="gray-bg">
			...
			<div class="col-sm-9">
				<div class="ibox">
					<div class="ibox-content">
									...
									<tr>
										...
										<td class="project-completion">
											<div class="input-group">
                                    				<button class="btn btn-primary" type="submit" style="margin-left: 0px;margin-top: 0px;"  onclick="searchFzByDt()">查询</button>
                                				</div>
										</td>
									</tr>
								</tbody>
						...
						<div id="doctorFzManageTable"></div>
					</div>
				</div>
			</div>
		</div>
    ...
    var contextPath="<%=contextPath%>";
    	...
    	function allFz(pageNo){
			$.ajax({
				url : contextPath + "/Doctor/allFz?pageNo="+pageNo,
				type : "get",
				dataType : "text",
				success : function(datas) {
					$("#doctorFzManageTable").html(datas);
		...
		function searchFzByDt(){

			var dt=$("#choosedate").val();

			$.ajax({
				url : contextPath + "/Doctor/searchFzByDt",
				type : "POST",
				data:{"dt":dt},
				dataType : "text",
				success : function(datas) {
