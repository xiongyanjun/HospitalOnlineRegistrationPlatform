...
<body class="gray-bg">
					...
					<div class="ibox-content mailbox-content">
						<div class="file-manager">
							<a class="btn btn-block btn-info compose-mail"
								href="${contextPath}/page/customer/customerMain.jsp">用户须知</a>
    ...
    var contextPath="<%=contextPath%>";
        ...
        function yuyueguanli(pageNo){
			$.ajax({
				url : contextPath + "/Customer/yuyueguanli?pageNo="+pageNo,
				type : "get",
				dataType : "text",
    ...
    function deleteYy(yyh) {
		layer.confirm('确认删除？', {
			...
			$.ajax({
				data :{yyh:yyh},
				url : contextPath + "/Customer/deleteYy",
				type : "get",
				dataType : "text",
				success : function(datas) {
