...
<body class="gray-bg" style="background-image: url('../img/T5.jpg')">

    <div class="middle-box text-center loginscreen   animated fadeInDown">
        <div>
            <div>

                <h1 class="logo-name" style="margin-left: -160px">Register</h1>
            ...
            <p>创建一个新账户</p>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <input class="form-control" value="用户" placeholder="请如实输入角色名称" required="" id="definition" >
                </div>
